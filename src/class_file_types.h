...
static u1 *CLASS_FILE_ATTRIBUTE_NAME_SOURCE_FILE = "SourceFile";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_INNER_CLASSES = "InnerClasses";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_ENCLOSING_METHOD = "EnclosingMethod";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_SOURCE_DEBUG_EXTENSION = "SourceDebugExtension";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_BOOTSTRAP_METHODS = "BootstrapMethods";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_CONSTANT_VALUE = "ConstantValue";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_CODE = "Code";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_EXCEPTIONS = "Exceptions";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_RUNTIME_VISIBLE_PARAMETER_ANNOTATIONS = "RuntimeVisibleParameterAnnotations";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_RUNTIME_INVISIBLE_PARAMETER_ANNOTATIONS = "RuntimeInVisibleParameterAnnotations";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_ANNOTATION_DEFAULT = "AnnotationDefault";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_METHOD_PARAMETERS = "MethodParameters";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_SYNTHETIC = "Synthetic";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_DEPRECATED = "Deprecated";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_SIGNATURE = "Signature";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_RUNTIME_VISIBLE_ANNOTATIONS = "RuntimeVisibleAnnotations";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_RUNTIME_INVISIBLE_ANNOTATIONS = "RuntimeInVisibleAnnotations";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_LINE_NUMBER_TABLE = "LineNumberTable";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_LOCAL_VARIABLE_TABLE = "LocalVariableTable";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_LOCAL_VARIABLE_TYPE_TABLE = "LocalVariableTypeTable";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_STACK_MAP_TABLE = "StackMapTable";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_RUNTIME_VISIBLE_TYPE_ANNOTATIONS = "RuntimeVisibleTypeAnnotations";
static u1 *CLASS_FILE_ATTRIBUTE_NAME_RUNTIME_INVISIBLE_TYPE_ANNOTATIONS = "RuntimeInvisibleTypeAnnotations";
